...
export default function LoginForm() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4">
            ...
            >
                <h1 className="text-2xl sm:text-3xl font-bold text-center mb-2">Log in</h1>
                ...
                <div className="text-center">
                    <span>Don't have account ? <a href="/auth/register" className="text-blue-600 hover:underline">Sign Up</a></span>
                </div>
